...
from wb_mqtt_bridge.domain.devices.models import LgTvState, LastCommand
from wb_mqtt_bridge.infrastructure.config.models import LgTvDeviceConfig, StandardCommandConfig
...
class LgTv(BaseDevice[LgTvState]):
    ...
    async def extract_certificate(self, output_file=None) -> Tuple[bool, str]:
        ...
        try:
            ...
            await secure_client.get_certificate(save_path=output_file)
