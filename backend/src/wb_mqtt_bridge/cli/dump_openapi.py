...
Usage:
    wb-openapi                  # write ./openapi.json
    wb-openapi -o path.json     # write to a specific path
    wb-openapi --stdout         # print to stdout
"""
...
from wb_mqtt_bridge.app.bootstrap import create_app
