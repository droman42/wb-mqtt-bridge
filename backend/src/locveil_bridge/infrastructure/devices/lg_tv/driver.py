...
from locveil_bridge.domain.devices.models import LgTvState, LastCommand
from locveil_bridge.infrastructure.config.models import LgTvDeviceConfig, StandardCommandConfig
