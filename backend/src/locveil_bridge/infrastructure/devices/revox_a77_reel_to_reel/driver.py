...
from locveil_bridge.domain.devices.models import RevoxA77ReelToReelState, LastCommand
from locveil_bridge.infrastructure.config.models import RevoxA77ReelToReelConfig, IRCommandConfig
