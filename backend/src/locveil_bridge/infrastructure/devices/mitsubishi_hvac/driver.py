...
from locveil_bridge.domain.devices.models import LastCommand, MitsubishiHvacState
from locveil_bridge.domain.devices.types import ActionHandler, CommandResult
...
from locveil_bridge.infrastructure.devices.value_translation import (
    coerce_state_value,
    parse_value,
    translate_inbound,
    translate_outbound,
