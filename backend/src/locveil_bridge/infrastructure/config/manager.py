...
from locveil_bridge.infrastructure.config.validation import (
...
class ConfigManager:
    ...
    def _load_config_class(self, config_class_name: str) -> Optional[Type[BaseDeviceConfig]]:
        ...
        """
        return load_class_by_name(config_class_name, BaseDeviceConfig, "locveil_bridge.infrastructure.config.models.")
