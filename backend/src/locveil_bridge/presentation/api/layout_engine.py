...
from locveil_bridge.domain.scenarios.proxy import SCENARIO_ROLE_DOMAIN
from locveil_bridge.domain.capabilities.models import Capability, CapabilityMap
from locveil_bridge.presentation.api.param_projection import project_params
from locveil_bridge.presentation.api.layout_manifest import (
    ActionIcon,
    DropdownConfig,
    DropdownOption,
    LayoutManifest,
